<?php
	...
	$connectionString = "DefaultEndpointsProtocol=https;AccountName=blobfaisal;AccountKey=4XM0EZsdi2xkoTsOr0d7K2catxP+0Il++fFG05LHoZ4sZKMbo9UVRN1wN+FU2X14D3DtIRkZjQ3GYk7Sa+wjTA==;EndpointSuffix=core.windows.net";
	$blobClient = BlobRestProxy::createBlobService($connectionString);
	$containerName = "faisalblob123";
